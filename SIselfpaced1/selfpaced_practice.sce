scenario = "selfpaced_practice.sce";		# name of scenario
pcl_file = "selfpaced_practice.pcl";    # open associated PCL file
no_logfile = true;							# save no logfile
...
trial {				#-----------------   INSTRUCTIONS   -----------------                       
   ...
   trial_duration = forever;
	picture {                                    
		text { caption =
"The practice is going to begin. Let the experimenter
know if you have any questions; otherwise, press
A to begin.";
...
trial {				#-----------------   BLOCK END   -----------------               
   ...
   trial_duration = forever;
		...
		picture { 
			text { caption = "The practice is finished. Please press A.";
